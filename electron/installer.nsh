...
!macro customInstall
  ...
  FileWrite $0 "PROVIDER_SCREENSAVER_URL=https://orh-frontend-dev-container.politebeach-927fe169.westus2.azurecontainerapps.io/wall/default$\r$\n"
  FileWrite $0 "# Provider in-session - params like roomId, inviteId will be appended$\r$\n"
  FileWrite $0 "PROVIDER_IN_SESSION_URL=https://orh-frontend-dev-container.politebeach-927fe169.westus2.azurecontainerapps.io/extensionproviderview$\r$\n"
  FileWrite $0 "$\r$\n"
